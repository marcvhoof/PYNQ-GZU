...
#
# basewerkend.tcl: Tcl script for re-creating project 'base'
#
# Generated by Vivado on Sun Sep 25 19:29:29 CEST 2022
...
#
# 1. This project restoration tcl script (basewerkend.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/media/marc/SpeedyLinux2/git4/PYNQ-GZU/Pynq-GZU/base/base/base.srcs/constrs_1/imports/constraints/base.xdc"
#
...
proc create_hier_cell_iop_pmod0 { parentCell nameHier } {
  ...
  connect_bd_net -net audio_codec_ctrl_0_bclk [get_bd_ports audio_codec_bclk] [get_bd_pins audio_codec_ctrl_0/bclk]
  connect_bd_net -net audio_codec_ctrl_0_codec_address [get_bd_ports codec_addr] [get_bd_pins audio_codec_ctrl_0/codec_address]
  connect_bd_net -net audio_codec_ctrl_0_lrclk [get_bd_ports audio_codec_lrclk] [get_bd_pins audio_codec_ctrl_0/lrclk]
  connect_bd_net -net audio_codec_ctrl_0_sdata_o [get_bd_ports audio_codec_sdata_o] [get_bd_pins audio_codec_ctrl_0/sdata_o]
